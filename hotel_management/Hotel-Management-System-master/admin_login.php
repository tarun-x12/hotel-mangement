...
<body>
	...
	<div style="background-color: rgba(20, 41, 54, 0.7);">
		<form action="admin_db.php" method="post">
			<table>
				<tr>
					<td colspan="2"><p style="font-size: 35px; color: #8c8c8c;"><b>Admin Login</b></p></td>
				</tr>
				<tr>
		...
		<br>
        <input class="button" style="font-size: 25px; color:rgb(82, 82, 82);text-decoration: none;" type="submit" value="Login">
		</form>
		<br>
		<table>
			<tr>
			...
			<tr>
				<td><button class="button"><a style="text-decoration: none;  font-size: 25px; color:rgb(82, 82, 82);" href="admin_signup.php">Admin SignUp</a></button></td>
				<td><button class="button"><a style="text-decoration: none;  font-size: 25px; color:rgb(82, 82, 82)" href="admin_forgot_pwd.php">Forgot Password</a></button></td>
			</tr>
		</table><br>
	</div>
</body>

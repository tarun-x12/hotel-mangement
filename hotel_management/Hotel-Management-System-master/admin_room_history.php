...
<div class="container-fluid">
    ...
    <?php
		...
		?>
    <div style="margin-left:25%;padding:1px 16px;height:1000px; margin-top:25px; color: #8c8c8c;font-size: 30px; text-align: center;">
        <table class="basic_box">
			...
			<form action="booking_history.php" method="post">
				<td colspan="2" style="text-align: center;"><button type="submit">BACK</button></td></form>
            </tr>
        </table>
    </div>
</body>

    ...
    <div style="margin-left:25%;padding:1px 16px;height:1000px;">
        <p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
            <table class="basic_box">
                <tr>
                    <td style="font-size: 28px; font-weight: bold;">Admin Room removed successfully</td>
                </tr>
                <tr>
                    <td style="font-size: 24px;"><a href="admin_view.php" style="color:#8c8c8c; text-decoration: underline;">Click here to get redirected.</a></td>
                </tr>
            </table>
        </div>
    </body>

    ...
    <div style="margin-left:25%;padding:1px 16px;height:1000px;">
        <p style="margin-left: 10%; margin-top: 5px; font-size: 28px;"></p>
            <table class="basic_box">
                <tr>
                    <td colspan="6"><p style="font-size: 28px; text-align: center; text-decoration: underline;"><b>BOOKINGS</b></p>
                </td>
                <tr>
                    <th>Booking ID</th>
                    <th>Name</th>
                ...
                <?php
                    ...
                    $sql1 = "SELECT * FROM user_room_book ORDER BY checkin";
            ...
            <table class="basic_box">
                ...
                <tr>
                    <td></td>
                    <td style="text-align: center;"><button type="submit">Check-IN</button>

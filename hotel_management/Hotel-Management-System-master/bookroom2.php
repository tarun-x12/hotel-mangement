...
<body>
    ...
    <div style="margin-left:25%;padding:1px 16px;height:1000px; color: #8c8c8c; font-size: 30px;">
		<p>Room Booked Successfully!<br>Looking forward to your checkin</p>
		<a href="user_view.php">Click here to get redirected to home page </a>
	</div>
</body>
</html>

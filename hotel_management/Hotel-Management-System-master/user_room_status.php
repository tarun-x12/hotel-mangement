	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			<table class="basic_box">
				<tr>
					<td colspan="7"><p style="font-size: 28px; text-align: center; text-decoration: none;"><b>Booked Room Status</b></p>
				</td>
				<tr>
					<th>Booking ID</th>
					<th>Name</th>
			...
			<table class="basic_box">
				<tr>
					...
					<td style="text-align: center;"><button type="submit" style="border-radius: 10px;background-color:#474747;color:#8c8c8c;">Cancel Booking</button></td></form>	
				</tr>
			</table>
	</div>
</body>
